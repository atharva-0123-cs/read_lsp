...
// you can do way more complicatied than this.
...
func (s *State) Hover(
	...
	// in real life, this would look up hte types in our type analysis

	documet := s.Documents[uri]
...
func (s *State) TextDocumentCompletion(
	...
	items := []lsp.CompletionItem{
		...
		{
			Label:         "atharva",
			Detail:        "hey, im atharva",
			Documentation: "Nice to meet you in my lsp",
		},
	}

	for word, emoji := range lsp.EmojiMapper {
		emojiCopy := emoji.Emoji // Create a copy of emoji
		items = append(items, lsp.CompletionItem{
			Label:         word,
			Detail:        emojiCopy,
			Documentation: emoji.Desc,
